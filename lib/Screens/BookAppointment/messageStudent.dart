...
class MessageStudent extends StatefulWidget {
  const MessageStudent({super.key});

  @override
  State<MessageStudent> createState() => _MessageStudentState();
}

class _MessageStudentState extends State<MessageStudent> {
  List<String> name = [
    "Dr. Kainat Nasir",
    "Dr. Irfan Lutfi",
    "Dr. Umna Khan",
            ...
            return ListTile(
                      ...
                      MaterialPageRoute(
                          builder: (builder) {
                            if(chatRoom.lastMessage!.seen == false &&
                              ...
                              {
                                FBCollections.chatRoom.doc(chatRoom.roomId).update({
                ...
                trailing:  CircleAvatar(
                  backgroundColor: chatRoom.lastMessage!.seen == false &&
                      chatRoom.lastMessage!.receiverId == product.email?  Colors.redAccent:Colors.transparent,
                  radius: 5,
                ));
          }
        });
