...
class ChatBotDiscussionPage extends StatefulWidget {
  final DiscussionM ?discussion;
  const ChatBotDiscussionPage({super.key,this.discussion});

  @override
  State<ChatBotDiscussionPage> createState() => _ChatBotDiscussionPageState();
}

class _ChatBotDiscussionPageState extends State<ChatBotDiscussionPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: discussionWidget(widget.discussion!),
    );
  }
                  ...
                  return Row(
                    children: [
                      CircularProfileAvatar(
                        ...
                        radius: 25,
                        elevation: 3,
                        child: Image.network(user.imageUrl == ""||user.imageUrl==null
                            ? UserData.avatar
                            : user.imageUrl!,fit: BoxFit.cover,),
                      ),
                      SizedBox(
                      ...
                      if(discussionM.createdBy==UserData.userProfile.uid)
                        Container(
                            ...
                            child: IconButton(onPressed: (){
                              ...
                              FBCollections.discussions.doc(discussionM.id).delete().then((value) {
                                ZBotToast.showToastSuccess(message: "Form deleted successfully",);
                              });
          ...
          if(discussionM.image!="")
            Container(
              ...
              child: ClipRRect(
                  ...
                  child: Image.network(discussionM.image!,fit: BoxFit.cover,)),
            ),
          ExpandableText(
