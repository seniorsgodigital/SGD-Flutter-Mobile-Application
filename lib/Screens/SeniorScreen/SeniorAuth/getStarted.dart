...
class SeniorSelectCategory extends StatefulWidget {
  const SeniorSelectCategory({super.key});

  @override
  State<SeniorSelectCategory> createState() => _SeniorSelectCategoryState();
}

class _SeniorSelectCategoryState extends State<SeniorSelectCategory> {
