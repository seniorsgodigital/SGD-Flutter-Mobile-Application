...
import 'package:seniors_go_digital/Screens/BookAppointment/All%20Students.dart';
...
import 'package:seniors_go_digital/Widget/text_field/SeniorDrawer.dart';
import 'package:seniors_go_digital/chat/init_chat.dart';
import 'package:seniors_go_digital/chat/model/chat_room_model.dart';
import 'package:seniors_go_digital/chat/show_appointment_senior.dart';
...
class SeniorAppointment extends StatefulWidget {
  const SeniorAppointment({super.key});

  @override
  State<SeniorAppointment> createState() => _SeniorAppointmentState();
}

class _SeniorAppointmentState extends State<SeniorAppointment> {
  List<String> name = [
    "Kainat Nasir",
    "Irfan Lutfi",
    "Umna Khan",
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              GestureDetector(
                onTap: () {
                  Get.to(const ShowAppointmentsSeniors());
                },
                child: Padding(
                  padding: const EdgeInsets.only(left: 31),
                  child: Container(
                        ...
                        return Padding(
                          ...
                          child: ListTile(
                            ...
                            leading: CircleAvatar(
                              backgroundImage:
                                  const AssetImage(AssetImages.personIcon),
                              child: Text(userProduct.name!
                                  .substring(0, 1)
                                  .toUpperCase()), // Replace with your image asset
                            ),
                            title: Text(
                              userProduct.name ?? "",
