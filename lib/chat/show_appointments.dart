    ...
    return Scaffold(
      ...
      body: product == null
          ...
          stream: FBCollections.appointments
              .where("query_by", isEqualTo: product!.email)
                ...
                child: Container(
                  ...
                  child: Column(
                    children: List.generate(snapshot.data!.docs.length, (index) {
                      AppointmentM appointmentM = AppointmentM.fromJson(snapshot.data!.docs[index].data());
        ...
        children: [
          FutureBuilder(
              future: FBCollections.userData
                  .where("email", isEqualTo: appointmentM.queryTo)
                  .get(),
              builder: (context, AsyncSnapshot<QuerySnapshot> snapshot) {
                if (!snapshot.hasData) {
